...
class Lichess:
    ...
    def __init__(self, token: str, url: str, version: str, logging_level: int, max_retries: int) -> None:
        ...
        token_info =  {'userId': 'time-cartoonist-2180', 'scopes': 'email:read,preference:read,preference:write,follow:read,follow:write,msg:write,challenge:read,challenge:write,challenge:bulk,tournament:write,team:read,team:write,team:lead,puzzle:read,puzzle:write,racer:write,study:read,study:write,board:play,bot:play,engine:read,engine:write', 'expires': None}
